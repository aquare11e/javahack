...
function fillIndividual(data) {
    ...
    $('.table').append('<tbody><tr><td>Наименование ЮЛ</td><td>'+data['egr']['items'][0]['ИП']['ФИОПолн']+'</td></tr>' +
        ...
        '<tr><td>Позитивные факторы</td><td>'+data['check']['items'][0]['ИП']['Позитив']['Текст']+'</td></tr>'+
        '<tr><td>Негативные факторы</td><td>'+data['check']['items'][0]['ИП']['Негатив']['Текст']+'</td></tr></tbody>');
...
function fillLegal(data) {
    ...
    $('.table').append('<tbody><tr><td>Наименование ЮЛ</td><td>'+data['egr']['items'][0]['ЮЛ']['НаимПолнЮЛ']+'</td></tr>' +
        ...
        '<tr><td>Позитивные факторы</td><td>'+data['check']['items'][0]['ЮЛ']['Позитив']['Текст']+'</td></tr>'+
        '<tr><td>Негативные факторы</td><td>'+data['check']['items'][0]['ЮЛ']['Негатив']['Текст']+'</td></tr></tbody>');
